...
const Favourites = () => {
    return (
        <div className="collapse" id="favorites" data-parent="#collapse-area">
            <ul className="songlist songlist-video fav-songlist">
                ...
                <div className="d-flex songlist-title">
                    <img src="/img/vexplore1.jpg" alt="song" />
                ...
                <li>
                <div className="d-flex songlist-title">
                    <img src="/img/vexplore2.jpg" alt="song" />
                    <span>Video name will be here <br /><small className="d-block d-md-none">Artist Name</small></span>
                </div>
                <div className="d-none d-md-block">Artist Name</div>
                <div className="d-none d-md-block">00:00</div>
                ...
                <li>
                <div className="d-flex songlist-title">
                    <img src="/img/vexplore3.jpg" alt="song" />
                    <span>Video name will be here <br /><small className="d-block d-md-none">Artist Name</small></span>
                </div>
                <div className="d-none d-md-block">Artist Name</div>
                <div className="d-none d-md-block">00:00</div>
                ...
                <li>
                <div className="d-flex songlist-title">
                    <img src="/img/vexplore4.jpg" alt="song" />
                    <span>Video name will be here <br /><small className="d-block d-md-none">Artist Name</small></span>
                </div>
                <div className="d-none d-md-block">Artist Name</div>
                <div className="d-none d-md-block">00:00</div>
                ...
                <li>
                <div className="d-flex songlist-title">
                    <img src="/img/vexplore5.jpg" alt="song" />
                    <span>Video name will be here <br /><small className="d-block d-md-none">Artist Name</small></span>
                </div>
                <div className="d-none d-md-block">Artist Name</div>
                <div className="d-none d-md-block">00:00</div>
